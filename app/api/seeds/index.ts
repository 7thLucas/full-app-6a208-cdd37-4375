...
export async function runSeeds(): Promise<void> {
  ...
  try {
    ...
    // Domain (non-module) seed — Pakettt! demo data. Runs after auth/admin seed.
    const { seedDeliveryDemo } = await import("~/api/delivery");
    logger.info("Running domain seed seedDeliveryDemo");
